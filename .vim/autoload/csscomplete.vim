...
elseif borders[max(keys(borders))] == 'colon'
	...
	elseif prop == 'background-color'
		let values = ["transparent", "rgb(", "rgba(", "#"]
	...
	elseif prop == 'background'
		let values = ["url(", "scroll", "fixed", "transparent", "rgb(", "rgba(", "#", "none", "top", "center", "bottom" , "left", "right", "repeat", "repeat-x", "repeat-y", "no-repeat"]
	elseif prop == 'border-collapse'
		let values = ["collapse", "separate"]
	elseif prop == 'border-color'
		let values = ["rgb(", "rgba(", "#", "transparent"]
    ...
    elseif prop == 'transform'
        let values = ["rotate", "rotateX", "rotateY", "rotateZ", "translate", "translateX", "translateY", "scale", "scaleX", "scaleY", "skew", "skewX" ,"skewY", "matrix"]
	else
